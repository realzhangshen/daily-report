"""OpenAI-compatible provider for entry-level analysis workflow."""
...
class OpenAICompatibleProvider(AnalysisProvider):
    """Provider using OpenAI Chat Completions compatible endpoints."""
    ...
    def decide_deep_fetch(
        ...
        with start_span(
            "openai_compatible.decide_deep_fetch",
            kind="llm",
            input_value=prompt,
            attributes={
